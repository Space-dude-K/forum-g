    ...
    public partial class ForumInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "0", "0", "My company", "6aa1bdea-348a-451e-bb2b-5c7ec50e8871", new DateTime(2023, 8, 28, 0, 20, 27, 816, DateTimeKind.Local).AddTicks(1785), "My division", "Admin@admin.by", false, "System", "0", "Admin", null, false, null, "ADMIN@ADMIN.BY", "ADMIN", "AQAAAAIAAYagAAAAEJmQy9UwxkODjbb/iQlo7ezznBC5omr0sEhFEoTgafpAxZZRFsyVCFG8NXKSc2SGJA==", "0", false, "Administrator", "FGXU4FIM2LMJZFDJD3YCUQEHQRZY4GSS", false, "Admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(2550), 1, "Test category 1", 1, 4, null },
                    { 2, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(2553), 1, "Test category 2", 5, 4, null },
                    { 3, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(2555), 1, "Test category 3", 0, 0, null },
                    { 4, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(2556), 1, "Test category 4", 0, 0, null },
                    { 5, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(2558), 1, "Test category 5", 0, 0, null },
                    { 6, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(2559), 1, "Test category 6", 0, 0, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(6116), 1, "Test forum subtitle 1", "Test forum title 1", 1, null, 0, null },
                    { 2, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(6120), 2, "Test forum subtitle 2", "Test forum title 2", 1, null, 0, null },
                    { 3, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(6122), 2, "Test forum subtitle 3", "Test forum title 3", 1, null, 0, null },
                    { 4, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(6123), 2, "Test forum subtitle 4", "Test forum title 4", 1, null, 0, null },
                    { 5, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(6125), 2, "Test forum subtitle 5", "Test forum title 5", 1, null, 0, null },
                    { 6, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(6127), 2, "Test forum subtitle 6", "Test forum title 6", 1, null, 0, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(9649), 1, 1, "Test forum topic 1", 0, 0, null },
                    { 2, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(9654), 2, 1, "Test forum topic 2", 0, 0, null },
                    { 3, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(9656), 2, 1, "Test forum topic 3", 0, 0, null },
                    { 4, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(9657), 2, 1, "Test forum topic 4", 0, 0, null },
                    { 5, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(9659), 2, 1, "Test forum topic 5", 0, 0, null },
                    { 6, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(9660), 1, 1, "Test forum topic 1a", 0, 0, null },
                    { 7, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(9661), 1, 1, "Test forum topic 1b", 0, 0, null },
                    { 8, new DateTime(2023, 8, 28, 0, 20, 27, 817, DateTimeKind.Local).AddTicks(9662), 1, 1, "Test forum topic 1c", 0, 0, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1370), 1, 1, 0, "1111111111111111111111", null },
                    { 2, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1376), 2, 1, 0, null, null },
                    { 3, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1377), 2, 1, 0, null, null },
                    { 4, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1378), 2, 1, 0, null, null },
                    { 5, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1379), 2, 1, 0, null, null },
                    { 6, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1380), 1, 1, 0, "222222222222222222", null },
                    { 7, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1382), 1, 1, 0, "333333333333333", null },
                    { 8, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1383), 1, 1, 0, "44444444444444", null },
                    { 9, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1384), 1, 1, 0, "555555555555555", null },
                    { 10, new DateTime(2023, 8, 28, 0, 20, 27, 818, DateTimeKind.Local).AddTicks(1385), 1, 1, 0, "666666666666666", null }
                });
